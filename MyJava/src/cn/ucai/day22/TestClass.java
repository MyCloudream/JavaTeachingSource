...
public class TestClass {
	public static void main(String[] args) throws Exception {
		...
		Person2 person = (Person2) c3.newInstance();
		System.out.println(person);
		
		// 通过反射调用构造方法
//		showConstructors(c3);
//		showFields(c3);
		showMethods(c3,person);
	}

	private static void showMethods(Class c,Person2 person) throws Exception{
...
//		method.setAccessible(true);
		method.invoke(person,"尚鹏");
		
		Method methodGetName = c.getDeclaredMethod("getName");
		String s = (String) methodGetName.invoke(person);// String s = p.getName();
